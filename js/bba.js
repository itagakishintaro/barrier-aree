...
function setTag(railway, railDirection){
  // 路線名を取得
  var railway_name = '';
  $.ajax({
    url: URL,
  ...
  $('#result').append('<div class="tag"><span class="label label-default">' + railway_name + '線</span> <span class="label label-default">' + railDirection_name + '駅方面行き</span></div>');
}
